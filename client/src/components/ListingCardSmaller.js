...
function ListingCardSmaller(props) {    
        ...
        <GridItem color={"greenyellow"} paddingY={4}>
            <Card maxW='xs' borderRadius={"xl"}>
                <CardBody>
                    ...
                    <AspectRatio maxH='70px'>
                    <Text lineHeight="1.2" fontFamily="sans-serif" fontSize="sm" textAlign="left">
                        {props.description}
                    </Text>

                    </AspectRatio>
                    {isSold && (
                        <Box position='absolute' top='139px' left='20px' width='30%' height='10%'
...
export default ListingCardSmaller;